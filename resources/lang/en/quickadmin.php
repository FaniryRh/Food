...
return [
	...
		'compte' => [		'title' => 'Compte Client',		'fields' => [			'nom-compte' => 'Nom',			'prenom-compte' => 'Prénom',			'mdp-compte' => 'Mot de passe',			'phone-compte' => 'Phone',			'mail-compte' => 'Email',			'adresse-compte' => 'Adresse',			'ville-compte' => 'Ville',			'quartier-compte' => 'Quartier',			'solde-compte' => 'Solde',		],	],
		'produit' => [		'title' => 'Produit',		'fields' => [			'photo-produit' => 'Photo',			'designation-produit' => 'Désignation',			'categorie' => 'Categorie',			'option-id' => 'Options',			'prix-unit-produit' => 'Prix unitaire',		],	],
		'typepayement' => [		'title' => 'Type payement',		'fields' => [			'designation-typepayement' => 'Désignation',		],	],
		'etat-livraison' => [		'title' => 'Etat livraison',		'fields' => [			'designation-etatlivraison' => 'Désignation',		],	],
		'statiques' => [		'title' => 'Statiques',		'fields' => [		],	],
		'options' => [		'title' => 'Options',		'fields' => [			'designation-option' => 'Désignation',		],	],
		'etat-commande' => [		'title' => 'Etat Commande',		'fields' => [			'designation-etatcom' => 'Désignation',		],	],
		'commandes' => [		'title' => 'Commandes',		'fields' => [		],	],
		'commandes-simples' => [		'title' => 'Commandes simples',		'fields' => [			'nom-client' => 'Nom et Prénom ',			'adresse-client' => 'Adresse',			'phone-client' => 'Téléphone',			'adresse-de-livraison' => 'Adresse de livraison',			'total-addition' => 'Totale',			'date-encaisse' => 'Date d\\\\\\\'encaissement',			'user' => 'Livreur',			'etat-cmd' => 'Etat commande',			'etat-livraison' => 'Etat Livraison',			'date-heur-souhaitee' => 'Date/heur souhaitée',			'date-heur-arrive-livr' => 'Date/heur arrivée livraison',			'map' => 'Map',		],	],
		'commandes-avec-compte' => [		'title' => 'Commandes avec compte',		'fields' => [			'compte' => 'Nom',			'user' => 'Livreur',			'adresse-de-livraison' => 'Adresse de livraison',			'date-heur-souhaitee' => 'Date/heur Souhaitée',			'date-depot-cmd' => 'Date dépot',			'date-livre-cmd' => 'Date livraison',			'total-addition' => 'Prix Total',			'etat-cmd' => 'Etat Commande',			'typepayement' => 'Type Payement',			'date-encaisse' => 'Date d\\\\\\\\\\\\\\\'encaissement',			'etat-livraison' => 'Etat Livraison',			'map' => 'Map',		],	],
		'menu' => [		'title' => 'Menu',		'fields' => [		],	],
		'inventaires-simple' => [		'title' => 'Inventaires simple',		'fields' => [			'cmd-simpl' => 'Commande',			'produit' => 'Produit',			'options' => 'Options',			'quantite' => 'Quantité',		],	],
		'inventaires-avec-compte' => [		'title' => 'Inventaires avec compte',		'fields' => [			'cmd-compt' => 'Commande',			'produit' => 'Produit ',			'options' => 'Options',			'quantite' => 'Quantité',		],	],
