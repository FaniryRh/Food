...
@section('content')
    ...
    {!! Form::model($inventaires_simple, ['method' => 'PUT', 'route' => ['admin.inventaires_simples.update', $inventaires_simple->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('options[]', $options, old('options') ? old('options') : $inventaires_simple->options->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
