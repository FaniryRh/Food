                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='prenom_user'>{{ $user->prenom_user }}</td>
                        </tr>
                        <tr>
...
<li role="presentation" class=""><a href="#commandessimples" aria-controls="commandessimples" role="tab" data-toggle="tab">Commandes simples</a></li>
</ul>
...
<div role="tabpanel" class="tab-pane " id="commandessimples">
