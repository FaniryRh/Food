...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('prenom_user', trans('quickadmin.users.fields.prenom-user').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('prenom_user', old('prenom_user'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
