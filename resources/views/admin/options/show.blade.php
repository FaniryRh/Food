            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>@lang('quickadmin.options.fields.designation-option')</th>
                            <td field-key='designation_option'>{{ $option->designation_option }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
<li role="presentation" class=""><a href="#produit" aria-controls="produit" role="tab" data-toggle="tab">Produit</a></li>
</ul>
...
<div role="tabpanel" class="tab-pane " id="produit">
