...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped ajaxTable @can('categorie_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        @can('categorie_delete')
...
@section('javascript') 
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [@can('categorie_delete')
                @if ( request('show_deleted') != 1 )
                    {data: 'massDelete', name: 'id', searchable: false, sortable: false},
                @endif
                @endcan{data: 'designation', name: 'designation'},
